...
//    DispMatrixForLatex(A, "A = ", 7);
    QMatrix5x1 x = CalcExactResult(q);
    DispMatrixForLatex(x, "x = ", 7);
    //cout << "x = \n";
    //DispMatrix(x);
    //cout << "\n";

//    QMatrix5x1 x = CalcExactResult(-5);
//    DispMatrixForLatex(x, "q = -5", 7);

//    x = CalcExactResult(-2);
//    DispMatrixForLatex(x, "x = -2", 7);

//    x = CalcExactResult(0);
//    DispMatrixForLatex(x, "x = 0", 7);

//    x = CalcExactResult(2);
//    DispMatrixForLatex(x, "x = 2", 7);

//    x = CalcExactResult(5);
//    DispMatrixForLatex(x, "x = 5", 7);

//    x = CalcExactResult(10);
//    DispMatrixForLatex(x, "x = 10", 7);
